;(()=>{
   ...
   ,mountain_display = m=>m.map(column=>'('+column.map(([v,sep])=>','.repeat(sep)+v).join('')+')').join('')
      ...
      if(!BRij){
         if(1===topright_separator){
            ...
            do{
               ...
               --working[1]
            }while(separator_compare(A[working[0]][working[1]]?.[1]??0,topright_separator)>=0);
   ...
   ,extend = (A0)=>{
      ...
      if(1===topright_separator){
         ...
         do{
            ...
            --working[1]
         }while(separator_compare(A0[working[0]][working[1]]?.[1]??0,topright_separator)>=0);
         BRij = [working[0],working[1]+1]
      }
