(function () {
	...
	if (typeof register !== 'undefined') {
		register.push({
			...
			display:
				typeof matrix_display !== 'undefined'
					? matrix_display
					: function (m) {
							return JSON.stringify(m);
						},
			able:
				typeof matrix_limit !== 'undefined'
					? matrix_limit
					: function (m) {
							return true;
						},
			compare:
				typeof matrix_compare !== 'undefined'
					? matrix_compare
					: function (a, b) {
			...
			FSalter: function (m, FSterm) {
				...
				else if (dataalter[datakey][FSterm] !== undefined)
					return dataalter[datakey][FSterm];
