(() => {
	var data = {},
		...
		expand = (M, FSterm) => {
			...
			var ascending_cache = {};
			var ascendingAt = (cur) => {
				//-1 means not ascending; otherwise row index of the BR column entry it corresponds
				var str = '' + cur;
	...
	register.push({
		...
		init: () => [
			{ expr: [[Infinity]], low: [[]], subitems: [], anal: 'Is not Ordinal' },
